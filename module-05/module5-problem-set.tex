  ...
  \item \textbf{Commitment demand as a diagnostic (5 pts).} A bank offers a
        ...
        \begin{enumerate}[label=(\roman*)]
          \item Compute the period-1 utility of the \emph{sophisticated}
                agent with and without the account. You may take $c_1 = 5$
                in both cases (with log utility, re-optimizing $c_1$ changes
                nothing); without the account she correctly foresees
...
A responder in a \$10 ultimatum game has Fehr--Schmidt utility\footnote{%
Notation: Fehr \& Schmidt (1999) call these parameters $\alpha$ and
$\beta$; we write $\gamma$ for the second to avoid a clash with the
discounting $\beta$ of Question 1.}
\[
...
\begin{enumerate}[label=(\alph*)]
  \item \textbf{(4 pts)} Assume $\gamma < 1$ and consider offers
        $s \le 5$. Show that the responder accepts an offer of $s$
